    ...
    return (
      <div style={{ textAlign: 'center', padding: 48 }}>
        ...
        <p style={{ color: '#64748b' }}>
          Không tìm thấy thẻ <strong>{id}</strong>
        </p>
        <button
          onClick={() => navigate(-1)}
          style={{
  ...
  return (
    <div style={{ maxWidth: 540, margin: '0 auto' }}>
      ...
      >
        ...
        <div style={{ fontFamily: 'monospace', fontSize: 20, letterSpacing: 2, marginBottom: 16 }}>
          {card.number}
        </div>
          ...
          <div style={{ height: 8, background: '#f1f5f9', borderRadius: 4 }}>
            <div
              style={{
                height: '100%',
                borderRadius: 4,
                background: card.balance / card.limit > 0.8 ? '#dc2626' : '#2563eb',
            ...
            {pinChanged ? (
              ...
              <>
                ...
                <div style={{ display: 'flex', gap: 10 }}>
                  ...
                  <button
                    onClick={() => {
                      if (newPin.length >= 4) setPinChanged(true);
                    }}
                    ...
                    style={{
                      ...
                      borderRadius: 8,
                      border: 'none',
                      background: newPin.length >= 4 ? '#1e3a5f' : '#e2e8f0',
        ...
        >
          <div style={{ background: '#fff', borderRadius: 16, padding: 28, width: 340 }}>
            ...
            <div style={{ fontSize: 13, color: '#64748b', marginBottom: 16 }}>
              Tính năng này yêu cầu xác thực OTP. Vui lòng liên hệ ngân hàng hoặc truy cập chi nhánh
              gần nhất.
            </div>
            <button
