  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
              ...
              <StatusBadge label={account.typeLabel} color={account.type === 'checking' ? 'blue' : 'yellow'} />
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        ...
        <Link to={`${id}/transactions`} style={{ fontSize: 13, color: '#2563eb', textDecoration: 'none', fontWeight: 500 }}>
          Xem toàn bộ lịch sử →
        </Link>
      </div>
          ...
          {txns.slice(0, 5).map((tx) => (
            <Card key={tx.id}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div style={{ fontWeight: 700, fontSize: 15, color: tx.type === 'credit' ? '#16a34a' : '#dc2626', flexShrink: 0 }}>
