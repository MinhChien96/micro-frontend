import type { Role } from '@app/common/auth';
import { getUser } from '@app/common/auth';
import { Button, Card, CardHeader, Divider, PageSpinner, StatusBadge } from '@app/common/ui';
    ...
    <div style={{ maxWidth: 600, margin: '0 auto' }}>
      ...
      <Card>
        <CardHeader
          ...
          subtitle={user.email}
          action={
            <StatusBadge label={ROLE_LABELS[role] || role} color={ROLE_COLOR[role] || 'blue'} />
          }
        />
        <Divider />
