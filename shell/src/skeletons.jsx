...
import { SkeletonCard, SkeletonList, SkeletonRow } from 'shared/ui';

// ── Transfer (/transfer/*) ──────────────────────────────────────────────────
// Khớp TransferDashboard: label + gradient account card + 4 quick actions + recent list
...
// Shimmer bar dùng lại trong các skeleton dưới
const Bar = ({ w = '60%', h = 14, mb = 0, opacity = 1 }) => (
  <div style={{
...
// ── Accounts (/accounts/*) ──────────────────────────────────────────────────
// Khớp AccountList: greeting + heading/total + 3 account cards
...
// ── Cards (/cards/*) ────────────────────────────────────────────────────────
// Khớp CardList: heading + 3 physical card visuals (gradient)
function CardSkeleton({ gradient }) {
  return (
...
// ── Loans (/loans/*) ────────────────────────────────────────────────────────
// Khớp LoanList: heading/dư nợ + button placeholder + 2 loan cards với progress bar
...
// ── Profile (/profile/*) ────────────────────────────────────────────────────
// Khớp ProfilePage: heading + card với 6 info rows + nút Chỉnh sửa
function InfoRowSkeleton({ labelW = '30%', valueW = '55%' }) {
  return (
